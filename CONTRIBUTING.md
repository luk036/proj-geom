...
Welcome to `proj-geom` contributor's guide.
...
If you experience bugs or general issues with `proj-geom`, please have a look
...
You can help improve `proj-geom` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`proj-geom` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `proj-geom`'s files. While this mechanism can
...
```
conda create -n proj-geom python=3 six virtualenv pytest pytest-cov
conda activate proj-geom
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/proj-geom.git
   cd proj-geom
   ```
...
5. Install [pre-commit]:
   ...
   `proj-geom` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/proj-geom
[issue tracker]: https://github.com/<USERNAME>/proj-geom/issues
